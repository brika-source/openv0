...
-- Reference schema for sqlite, generated from app/Schema.php.
...
CREATE INDEX IF NOT EXISTS idx_cases_employee ON sick_cases (employee_id);
CREATE INDEX IF NOT EXISTS idx_cases_status ON sick_cases (status);
CREATE INDEX IF NOT EXISTS idx_cases_from ON sick_cases (from_date);
CREATE INDEX IF NOT EXISTS idx_case_history_case ON case_history (case_id, ts);
CREATE INDEX IF NOT EXISTS idx_case_docs_case ON case_documents (case_id);
CREATE INDEX IF NOT EXISTS idx_case_ext_case ON case_extensions (case_id);
CREATE INDEX IF NOT EXISTS idx_ftw_employee ON ftw_requests (employee_id);
CREATE INDEX IF NOT EXISTS idx_ftw_status ON ftw_requests (status);
CREATE INDEX IF NOT EXISTS idx_ftw_demands ON ftw_job_demands (ftw_id);
CREATE INDEX IF NOT EXISTS idx_ftw_att ON ftw_attachments (ftw_id);
CREATE INDEX IF NOT EXISTS idx_ftw_history ON ftw_history (ftw_id, ts);
CREATE INDEX IF NOT EXISTS idx_notif_ts ON notifications (ts);
CREATE INDEX IF NOT EXISTS idx_notif_target ON notification_targets (target);
CREATE INDEX IF NOT EXISTS idx_notif_target_nid ON notification_targets (notification_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_notif_read ON notification_reads (notification_id, user_id);
